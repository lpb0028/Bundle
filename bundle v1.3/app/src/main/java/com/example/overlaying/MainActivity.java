...
public class MainActivity extends AppCompatActivity {
    ...
    // Debug Messages
    public static final boolean ENTITY_DEBUG_MESSAGES = false;
    public static final boolean ENTITY_DEBUG_VISUALS = false;
    ...
    protected void onStop() {
        if(isBound) binder.SaveInventoryToFile();
        ...
        if(newMenu != activeMenu) {
            ...
            switch (newMenu) {
                ...
                case 3:
                    ...
                    if(isBound) binder.AddItemToInventory(ItemDictionary.searchItem(3), 1);
                    inventoryFragment.updateInventoryDisplay(this);
                    return;
            ...
            if(isBound) binder.AddItemToInventory(ItemDictionary.searchItem(newMenu), 1);
            fragmentTransaction.commit();
        }
    }
