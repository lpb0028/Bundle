...
public class InventoryManager {
    ...
    public void readInventoryFromFile() throws RuntimeException {
        ...
        try {
            ...
            manager.toastManager.addToast("Inventory Read Successful!", 1500);
        }
        catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
            System.out.println("<!> Inventory Read Failed <!>");
            manager.toastManager.addToast("<!> Inventory Read Failed <!>", 1500);
        }
    }
    public boolean writeInventoryToFile() {
        try {
            ...
            manager.toastManager.addToast("<!> Inventory Write Failed <!>", 1500);
        }
        return false;
    }
    ...
    public void addItemToInventory(Item item, int amount) {
        ...
        if(drawable != null) {
            ...
            manager.toastManager.addToast(message, 750);
        }
        else
